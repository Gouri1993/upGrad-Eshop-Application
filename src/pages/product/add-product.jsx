...
export const Products = () => {
  ...
  const handleCategoryChange = (_, newCategory) => {
    if (newCategory === 'All') setProducts(productList);
    else setProducts(productList?.filter((product) => product.category === newCategory));
  };
  ...
  return (
    <>
      ...
      <Container sx={{ marginTop: 4 }}>
        <StyledToggleButtonGroup value={category} exclusive onChange={handleCategoryChange}>
        ...
        <Box>
          <FormControl
            style={{ minWidth: 400, float: 'left', marginTop: 25, textAlign: 'justify' }}>
